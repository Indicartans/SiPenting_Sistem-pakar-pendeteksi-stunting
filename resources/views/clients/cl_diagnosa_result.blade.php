                ...
                <div class="col-md-10 mx-auto">
                    <div class="card my-4">
                        ...
                        <div class="card-body">
                            ...
                            @endauth
                            @guest
                                <p class="card-text">Berdasarkan dari gejala yang anda isikan dapat disimpulkan bahwa anak anda
                                    memiliki penyakit <span
                                        class="fw-semibold">{{ $diagnosa_dipilih['kode_depresi']->depresi }}</span> dengan
                                    tingkat kepastian
