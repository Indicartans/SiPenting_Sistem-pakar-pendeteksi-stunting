                                            ...
                                            @foreach ($kondisi_user as $kondisi)
                                                <div class="form-check-inline">
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        id="kondisi_{{ $kondisi->nilai }}" value="{{ $kondisi->nilai }}">
                                                    <label class="form-check-label" for="kondisi_{{ $kondisi->nilai }}"
                                                        style="display: block; font-size: smaller;">{{ $kondisi->kondisi }}</label>
                                                </div>
                                            @endforeach
                                        </div>
                                    </td>
